...
DROP FUNCTION IF EXISTS HelperTablesLoadInc1();
CREATE FUNCTION HelperTablesLoadInc1()
RETURNS VOID AS $$
BEGIN

	DROP TABLE IF EXISTS Account1,BatchDate1,CashTransaction1,Customer1,DailyMarket1,HoldingHistory1,TempProspect1,
	Trade1,WatchHistory1;
	...
	CA_ST_ID CHAR(4)
        ...
        COPY Account1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\Account.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');
	
	
	CREATE TABLE TempProspect1 ( AgencyID CHAR(30) NOT NULL UNIQUE,  
	...
	COPY TempProspect1(AgencyID, LastName, FirstName,
	...
	FROM 'D:\TPC-DI_Staging_Area\data\Batch2\Prospect.csv'  DELIMITER ',' CSV HEADER; 

	--UPDATE TempProspect1
	--	SET
	--	AddressLine2=NULL
	--	WHERE 
	--	AddressLine2='';
	...
	CREATE  TABLE BatchDate1(
	BatchDateColumn Date NOT NULL
	);
	
	COPY BatchDate1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\BatchDate.txt' 
	...
	COPY Customer1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\Customer.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');
	...
	COPY CashTransaction1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\CashTransaction.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');

	CREATE  TABLE HoldingHistory1(
	CDC_FLAG CHAR(1) CHECK (CDC_FLAG = 'I'),
	CDC_DSN NUMERIC(12) NOT NULL,
	...
	COPY HoldingHistory1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\HoldingHistory.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');
	



	CREATE  TABLE DailyMarket1(
	CDC_FLAG CHAR(1) CHECK (CDC_FLAG = 'I'),
	CDC_DSN NUMERIC(12) NOT NULL,
	...
	COPY DailyMarket1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\DailyMarket.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');


	CREATE  TABLE WatchHistory1(
	CDC_FLAG CHAR(1) CHECK (CDC_FLAG = 'I'),
	CDC_DSN NUMERIC(12) NOT NULL,
	...
	COPY WatchHistory1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\WatchHistory.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');
	...
	COPY Trade1 FROM 'D:\TPC-DI_Staging_Area\data\Batch2\Trade.txt' 
	( FORMAT text, ENCODING 'UTF8', DELIMITER '|');
